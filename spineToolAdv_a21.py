...
#dockSpineItemTree dockCamview
    ...
    def defineImageButtonDock(self):
        ...
        self.trimAfterFrameBtn.setGeometry(QtCore.QRect(220, 10, 100,30))
        ...
        self.trimAfterFrameLEdit.setGeometry(QtCore.QRect(320, 10, 100, 30))
        ...
        self.trimBetweenFrameBTN.setText(QtWidgets.QApplication.translate("MainWindow", "trim between Frame", None, -1))
        ...
        self.offsetFrameBtn.setGeometry(QtCore.QRect(220, 90, 100,30))
        ...
        self.offsetFrameLEdit.setGeometry(QtCore.QRect(330, 90, 100, 30))
    ...
    def alignKeys(self):
        print "alignKeys"
        objList = self.getObjList()
        alignFrame = float(self.alignToFrameLEdit.text())
       # print objList
        for obj in objList:
         #   print obj
            keyFrameList= []

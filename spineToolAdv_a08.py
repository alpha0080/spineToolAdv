    ...
    def defineVertexsValueDeltaTime(self,allKeyFrameListByDeformers):
       ...
       # print 'meshList',meshList
        for mesh in meshList:
            ...
            meshDeformDict.update({slotName:{mesh:[]}})
            ...
            for f in keyFrameList:
               ...
               # meshDeformDict[slotName].append({slotName:{"time":f/30.0,"vertices":deltaVertexPositionPreFrameList}})
...
#
    ...
    def defineExportData(self,boneList,skinDict,slotList,animationDict):
        ...
        exportFile = "C:/temp/images/test_02.json"
        exportData = {'skeleton':{},
                         'bones':boneList,
                         'slots':slotList,
                         'skins':skinDict,

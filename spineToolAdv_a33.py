...
#cmds.cutKey( 'bone_star_A02_18', time=(0,3),option="keys" )                            
    ...
    def defineAllAnimLayerDict(self,animLayerName,slotList,allBoneList,allMeshSlotList,characterSetGrp):
      ...
      #  print 'boneRegionTimeLineDict',animLayerName,boneRegionTimeLineDict
        ...
        for slot in slotList:
            ...
            if cmds.getAttr('%s.spine_tag'%boneName) == "spine_bone":
                regionSlotList.append(slot)
            if cmds.getAttr('%s.spine_tag'%boneName) == "spine_characterSet":
                meshSlotList.append(slot)
    ...
    #### 輸出     
    def defineDeformAnimation(self,boneInAnimLayer,boneNotInAnimLayer):
       ...
       # fileName = self.selectExportFileBTnLEdit.text()
        ...
        for slot in slotNotInAnimLayer:
            ...
            if cmds.getAttr('%s.spine_tag'%boneName) == "spine_characterSet":
                ...
                tempSlorColordTdict = {slotName:{"color": [{'color': 'ffffffff', 'dark': '000000ff', 'time': 0.0}]}}

...
#dockSpineItemTree dockCamview
    ...
    def defineImageButtonDock(self):
        ...
        lineEditRightB = "\
                         ...
                         "%(str(self.fontScale),str(self.fontScale))   
      ...
      #  self.openMayaFileFolder.clicked.connect(self.openSpineFolder)
       ...
       # self.jointSizeValueLabel.setStyleSheet(labelTextA)
        ...
        self.jontSizeLEdit = QtWidgets.QLineEdit(self.environmentSetGrp)
        ...
        self.jontSizeLEdit.setText('10.0')
        self.jontSizeLEdit.setStyleSheet(labelTextA)  
      ...
      #  self.amountSlotSlider.setStyleSheet(lineEditA)
       ...
       #### define dynamic slots
        ...
        optionEditA  = "\
                         ...
                         "%(str(self.fontScale),str(self.fontScale),str(self.fontScale))

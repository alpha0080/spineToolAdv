...
#dockSpineItemTree dockCamview
    ...
    def defineImageButtonDock(self):
        ...
        self.errMsgLabel.setGeometry(QtCore.QRect(10, 10, 300, 50))
        ...
        self.errorMsgLEdit.setGeometry(QtCore.QRect(10, 50,350, 60))
        ...
        self.initialSpineRootBtn = QtWidgets.QPushButton(self.dockSpineMeshProgress)
        self.initialSpineRootBtn.setGeometry(QtCore.QRect(10, 120, 150, 30))
        ...
        self.spineRootLEdit = QtWidgets.QLineEdit(self.dockSpineMeshProgress)
        self.spineRootLEdit.setGeometry(QtCore.QRect(160, 120, 200, 30))
        ...
        self.createCharacterGrpBTn.setGeometry(QtCore.QRect(30, 160, 130,30))
        ...
        self.characterNameLEdit.setGeometry(QtCore.QRect(160, 160, 180, 30))
        ...
        self.createRootBtn.setGeometry(QtCore.QRect(30, 200, 130, 30))
        ...
        self.rootNameEdit.setGeometry(QtCore.QRect(160, 200, 140, 30))
        ...
        self.rootCtrlScaleEdit.setGeometry(QtCore.QRect(300,200, 40, 30))
        ...
        self.defineMeshBtn.setGeometry(QtCore.QRect(30, 250, 150, 30))
        ...
        self.testDBtn = QtWidgets.QPushButton(self.dockSpineMeshProgress)
        self.testDBtn.setGeometry(QtCore.QRect(10, 400, 100, 30))
        ...
        self.treeView = QtWidgets.QTreeView(self.dockExport)
        self.treeView.setGeometry(QtCore.QRect(0, 200, 300, 300))
    ...
    def getImageSourcesDir(self):
       ...
       # print os.listdir(imagesRoot)
        ...
        while searchLoopCount <5 :
            ...
            if searchLoopCount == 0 :
                parentDir = imagesRoot
                childDir = self.findChildDir(parentDir)
                searchPath = childDir
                searchLoopCount  = searchLoopCount +1
                for pathName in childDir:
                    fullPathNameList.append(pathName.split(imagesRoot)[1])
                    
            if searchLoopCount >0:
                searchLoopCount  = searchLoopCount +1
                for p in searchPath:
                    childDir = self.findChildDir(p)
                    searchPath = childDir
                    for pathName in childDir:
                        fullPathNameList.append(pathName.split(imagesRoot)[1])
            ...
            #print searchLoopCount
            
           # create model
        #startDir = QtCore.QString("")
        startDir = "//mcd-3d/webServer/static/imageSources"
       ...
       # model.setRootPath(imagesRoot)
        print model
        self.treeView.setModel(model)
        #self.spineItemTree.setModel(model)
        #self.spineItemTree.setModel
            # set the model

           # self.ui.treeView.setModel(model)

        print "get image sources",fullPathNameList
    ...
    def defineSpineWorkSpace(self):
        basicFilter = "*.json"
        exportFileName = cmds.fileDialog2(fileFilter=basicFilter, dialogStyle=1,fm=2)[0]
        self.spineWorkSpaceLEdit.setText(exportFileName)

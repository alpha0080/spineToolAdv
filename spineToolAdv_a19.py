...
#dockSpineItemTree dockCamview
    ...
    def defineImageButtonDock(self):
        ...
        self.trimBeframeBeforeBtn = QtWidgets.QPushButton(self.keyFrameToolGrp)
        self.trimBeframeBeforeBtn.setGeometry(QtCore.QRect(10, 10, 100,30))
        self.trimBeframeBeforeBtn.setObjectName("trimBeframeBeforeBtn")
        self.trimBeframeBeforeBtn.setText(QtWidgets.QApplication.translate("MainWindow", "trim Before", None, -1))
        self.trimBeframeBeforeBtn.clicked.connect(self.createCharacterGrp)
        self.trimBeframeBeforeBtn.setStyleSheet(buttonStyleLeftB)     

 
        self.trimBeframeBeforeLEdit = QtWidgets.QLineEdit(self.keyFrameToolGrp)
        self.trimBeframeBeforeLEdit.setGeometry(QtCore.QRect(110, 10, 100, 30))
        self.trimBeframeBeforeLEdit.setObjectName("trimBeframeBeforeLEdit")
        self.trimBeframeBeforeLEdit.setAlignment(QtCore.Qt.AlignCenter)
        self.trimBeframeBeforeLEdit.setText('1.0')
        self.trimBeframeBeforeLEdit.setStyleSheet(lineEditRightBDark)     
        
        
        
            
        self.trimBeframeAfterBtn = QtWidgets.QPushButton(self.keyFrameToolGrp)
        self.trimBeframeAfterBtn.setGeometry(QtCore.QRect(220, 10, 100,30))
        self.trimBeframeAfterBtn.setObjectName("trimBeframeAfterBtn")
        self.trimBeframeAfterBtn.setText(QtWidgets.QApplication.translate("MainWindow", "trim After", None, -1))
        self.trimBeframeAfterBtn.clicked.connect(self.createCharacterGrp)
        self.trimBeframeAfterBtn.setStyleSheet(buttonStyleLeftB)     

 
        self.trimBeframeAfterLEdit = QtWidgets.QLineEdit(self.keyFrameToolGrp)
        self.trimBeframeAfterLEdit.setGeometry(QtCore.QRect(320, 10, 100, 30))
        self.trimBeframeAfterLEdit.setObjectName("trimBeframeAfterLEdit")
        self.trimBeframeAfterLEdit.setAlignment(QtCore.Qt.AlignCenter)
        self.trimBeframeAfterLEdit.setText('100.0')
        self.trimBeframeAfterLEdit.setStyleSheet(lineEditRightBDark)     
        
        
                           
        self.alignToFrameBtn = QtWidgets.QPushButton(self.keyFrameToolGrp)
        self.alignToFrameBtn.setGeometry(QtCore.QRect(10, 50, 100,30))
        self.alignToFrameBtn.setObjectName("alignToFrameBtn")
        self.alignToFrameBtn.setText(QtWidgets.QApplication.translate("MainWindow", "Align Frame", None, -1))
        self.alignToFrameBtn.clicked.connect(self.createCharacterGrp)
        self.alignToFrameBtn.setStyleSheet(buttonStyleLeftB)     

 
        self.alignToFrameLEdit = QtWidgets.QLineEdit(self.keyFrameToolGrp)
        self.alignToFrameLEdit.setGeometry(QtCore.QRect(110, 50, 100, 30))
        self.alignToFrameLEdit.setObjectName("alignToFrameLEdit")
        self.alignToFrameLEdit.setAlignment(QtCore.Qt.AlignCenter)
        self.alignToFrameLEdit.setText('1.0')
        self.alignToFrameLEdit.setStyleSheet(lineEditRightBDark)     
        
        self.offsetFrameBtn = QtWidgets.QPushButton(self.keyFrameToolGrp)
        self.offsetFrameBtn.setGeometry(QtCore.QRect(10, 90, 100,30))
        ...
        self.scaleTimeBtn.clicked.connect(self.createRootCtrl)
        ...
        self.scaleTimeOriginIN.setText('original in')
        ...
        self.scaleTimeOriginOut.setText('original out')
        ...
        self.scaleTimeNewIn.setText('scaled in')
        ...
        self.scaleTimeNewOut.setText('scaled out')
        ...
        self.loopTimeBtn.clicked.connect(self.createRootCtrl)
        ...
        self.loopTimeIn.setText('original in')
        ...
        self.loopTimeOut.setText('original out')
        self.loopTimeOut.setStyleSheet(lineEditRightBMiddleDark)     
        
        self.loopOffsetRange = QtWidgets.QLineEdit(self.keyFrameToolGrp)
        self.loopOffsetRange.setGeometry(QtCore.QRect(310, 170, 100, 30))
        self.loopOffsetRange.setObjectName("loopOffsetRange")
        self.loopOffsetRange.setAlignment(QtCore.Qt.AlignCenter)
        self.loopOffsetRange.setText('offset range')
        self.loopOffsetRange.setStyleSheet(lineEditRightBMiddleDark)     
        ...
        self.loopTimes.setText('loop times')
        ...
        self.modTransXBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modTransXMaxLedit.setText('0')
        ...
        self.modTransYBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modTransYMaxLedit.setText('0')
        ...
        self.modTransZBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modRotateXBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modRotateYBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modRotateZBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modScaleXBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modScaleYBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modScaleZBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modScaleAllBtn.clicked.connect(self.createRootCtrl)
        ...
        self.modAlphaGainBtn.clicked.connect(self.createRootCtrl)
